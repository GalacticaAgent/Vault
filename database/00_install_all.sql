-- =============================================
-- Vault 数据库安装脚本（主脚本）
-- 描述: 按顺序执行所有SQL脚本，完成数据库的完整安装
-- 版本: 1.0
-- 日期: 2026-01-21
-- 使用方法: mysql -u root -p < 00_install_all.sql
-- =============================================

SELECT '
╔═══════════════════════════════════════════════════╗
║                                                   ║
║       Vault Database Installation Script         ║
║                   Version 1.0                     ║
║                                                   ║
╚═══════════════════════════════════════════════════╝
' AS '';
...
- Optimize MySQL configuration for production use
- Monitor performance and adjust indexes as needed
' AS 'Security Reminders';
